...
export type SupportWeaponPreset = {
  id: string
  name: string
  /** Direct-hit ballistic profile (wiki “Detailed Weapon Statistics”, primary attack). */
...
/** Sourced from https://helldivers.wiki.gg/wiki/Stratagems (Support Weapons) and individual weapon pages. */
export const SUPPORT_WEAPON_PRESETS: SupportWeaponPreset[] = [
  ...
  },
  {
    ...
    damageMode: 'ballistic',
    explosiveDamage: 0,
    notes: 'Wiki lists Laser type; this app treats the beam as ballistic for the same AP/durable formula.',
  },
  {
    id: 'eat-17',
  ...
  },
  {
    ...
    explosiveDamage: 400,
    notes: 'Impact projectile is 0 ballistic; inner AoE is 400 explosive at Medium pen vs armor (explosive portion still uses AP3 in this calculator).',
  },
  {
    id: 'gr-8-heat',
